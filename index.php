...
<body>
    ...
    <?php   
        ...
        /* 
            SOAL NO 1
            Tunjukan dengan menggunakan echo berapa panjang dari string yang diberikan berikut! Tunjukkan juga jumlah kata
        ...
        */
        ...
        echo "<br> Kata Ketiga: " .substr($string2, 4, 3). "<br>";
        ...
        */
        ...
        echo "<p> Ganti:" .str_replace("sexy","awesome",$string3). "</p>";
    ?>
    <?php
